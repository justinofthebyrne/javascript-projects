  ...
  if (response.toLowerCase()==='y'){
    if (i===0){
      ...
      for (let j = 0; j<testTitles.length; j++){
        let avg = averages.averageForStudents(j, scores); //Call 'averageForTest' here. Pass in j and scores as arguments.
      ...
      let walker = astronauts.randomSelect[0]; //Call 'randomSelect' to pick a spacewalker from the astronauts array.
